...
/*максимальная длина описания гостиницы*/
const MAX_DESCRIPTION_LENGTH = 100;

const HotellCard = React.createClass({
...
const HotellApp = React.createClass({
	...
	/*функция для отработки события для ReactDOM*/
	handleSearch(e){
	...
	render: function(){
		...
		return (
			<div className="app">
				<div className="header">HotelApp</div>
